 ...
 */
function sendHmiAppFilter( index, block, addressOffset ) {

  // Calculate the start address of the block (assumes all blocks are the same length)
  let address = (index * block.length / 2) + addressOffset;
 ...
 * @return array bytes to be sent to the device.
 */
function sendSimpleFilter( index, block, addressOffset ) {

  // Calculate the start address of the block (assumes all blocks are the same length)
  let address = index * block.length + addressOffset;
